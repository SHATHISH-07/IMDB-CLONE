    ...
    <div className="p-5 bg-gradient-to-r from-gray-400 via-gray-100 to-gray-400 dark:from-gray-900 dark:via-gray-700 dark:to-gray-900 dark:text-white">
      ...
      <div className="flex justify-center">
        ...
        {searchResult.length > 0 && (
          <div className="absolute top-[415px] md:top-[280px] bg-gray-300 dark:bg-gray-900 w-[350px] h-[450px] md:w-[700px] md:h-[450px] shadow-lg rounded-lg z-10 overflow-y-scroll scrollbar-custom">
